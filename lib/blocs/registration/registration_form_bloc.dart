...
class RegistrationFormBloc extends Object
    with EmailValidator, PasswordValidator, NombreValidator
    implements BlocBase {
  ...
  // Validators
  //
  Stream<String> get nombre =>
      _nombreController.stream.transform(validateNombre);
  Stream<String> get apellido =>
      _apellidoController.stream.transform(validateNombre);
